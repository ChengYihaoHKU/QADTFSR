...
if __name__ == "__main__":
    model = UNetModelSwin(image_size=64, in_channels=3, model_channels= 160,
                          out_channels=3, attention_resolutions=[64,32,16,8],
                          dropout=0, channel_mult=[1,2,2,4], num_res_blocks=[2,2,2,2],
                          conv_resample=True, dims=2, use_fp16=False, num_head_channels=32,
                          use_scale_shift_norm=True, resblock_updown=False, swin_depth=2,
                          swin_embed_dim=192, window_size=8, mlp_ratio=4, cond_lq=True,
                          cond_mask=True,lq_size=256,
                          )
